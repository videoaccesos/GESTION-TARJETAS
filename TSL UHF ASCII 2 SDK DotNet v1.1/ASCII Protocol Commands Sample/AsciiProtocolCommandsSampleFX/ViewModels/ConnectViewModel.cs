...
namespace TechnologySolutions.AsciiProtocolSample.ViewModels
{
        ...
        : PropertyChangedViewModel
    {
        ...
        /// <summary>
        /// The connection settings that determine what to connect to
        /// </summary>
        private Entities.IObservableConnectSettings connectSettings;
        ...
        /// </summary>
        /// <param name="connection">The service to manage the connection to the reader</param>
        public ConnectViewModel(IConnectionService connection)
            : base()
        {
            if (connection == null)
            {
            ...
            this.connectSettings = new Entities.ConnectSettingsAdapter();
            this.connectSettings.PropertyChanged +=
                delegate(object sender, PropertyChangedEventArgs e) { this.OnPropertyChanged(e.PropertyName); };
            ...
            this.PortName = this.connectSettings.PortName;
        ...
        {            
            ...
            {
                this.connectSettings.PortName = this.PortName;
            }
