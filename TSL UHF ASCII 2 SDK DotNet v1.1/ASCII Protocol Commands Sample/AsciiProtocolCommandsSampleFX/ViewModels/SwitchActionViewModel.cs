...
namespace TechnologySolutions.AsciiProtocolSample.ViewModels
{
        ...
        : PropertyChangedViewModel
    {
        ...
        public SwitchActionViewModel(ICommandService commander)
            : base()
        {
            if (commander == null)
            {
        ...
        /// <summary>
        /// Gets the available switch actions
        /// </summary>
        public ICollection<SwitchAction> SwitchActions
        {
            get
            {
                return (SwitchAction[])Enum.GetValues(typeof(SwitchAction));
            }
        }
        ...
        /// </summary>
        /// <param name="parameter">Not currently user</param>
