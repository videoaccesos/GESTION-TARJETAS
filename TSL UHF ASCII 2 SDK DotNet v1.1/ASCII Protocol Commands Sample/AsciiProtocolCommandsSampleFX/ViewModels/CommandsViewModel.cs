...
namespace TechnologySolutions.AsciiProtocolSample.ViewModels
{
        ...
        : PropertyChangedViewModel
    {
            ...
            : base()
        {
            ...
            this.ExecuteAutorunCommand = new ReaderCommand(this.ExecuteExecuteAutorun, ReaderCommandCanExecute.WhenConnectedAndIdle);
        ...
        /// <summary>
        /// Gets the ICommand instance that will perform the command to execute the autorun file
        /// </summary>
        public ICommand ExecuteAutorunCommand { get; private set; }
        ...
        /// <summary>
        /// Commands the reader to execute the autorun file
        /// </summary>
        /// <param name="parameter">Parameter not used</param>
        private void ExecuteExecuteAutorun(object parameter)
        {
            ExecuteAutorunCommand command;                       

            this.messages.IssueMessage(true, "Execute Autorun", "Executing...");
            command = new ExecuteAutorunCommand();
            this.commander.Execute(command, true);
            this.messages.IssueMessage(true, "Execute Autorun", "Done.");
        }
