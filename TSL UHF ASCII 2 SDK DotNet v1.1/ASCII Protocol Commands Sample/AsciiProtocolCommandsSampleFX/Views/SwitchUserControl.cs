        ...
        : UserControl
    {
        ...
        public SwitchUserControl()
        {
            ...
            if (this.viewModel != null)
            {
                ...
                this.commandBindings.Bind(this.switchDoublePressButton, this.viewModel.SwitchDoublePressCommand);
                this.commandBindings.Bind(this.switchSinglePressButton, this.viewModel.SwitchSinglePressCommand);
                this.commandBindings.Bind(this.readSwitchStateButton, this.viewModel.ReadSwitchState);
            }
        }
    }
}
